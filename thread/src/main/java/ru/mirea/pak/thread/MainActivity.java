...
import ru.mirea.pak.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("\nМОЙ НОМЕР ГРУППЫ: 07-21, " + "\nНОМЕР ПО СПИСКУ: 18," + "\nМОЙ ЛЮБИИМЫЙ ФИЛЬМ: Большой куш ");
            ...
            public	void	onClick(View	v)	{
                new	Thread(new	Runnable()	{
                    public	void run()	{
                        ...
                        Log.d("ThreadProject",	String.format("Запущен	поток	№%d	студенткой	группы	%s	номер	по списку	№%d	",	numberThread, "БСБО-07-21",	18));
